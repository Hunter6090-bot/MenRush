-- Live nearby map feed (ephemeral geo messages). No raw coords exposed to other clients.
...
-- Temporary identity inside a specific room (never written to profiles).
...
-- Official curated rooms + theme slug for catalog.
ALTER TABLE rooms
