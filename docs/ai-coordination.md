...
| --- | --- | --- | --- |
| P0 map vertical stack (Cruise/people pins) | this branch `cursor/fix-map-vertical-stack-pins-e0ea` | — | Cursor cloud — Al P0: HotSpotPin root `position:relative` overrode Mapbox absolute → zoomed-out vertical column; remove override + CSS lock + mercator; Hot Spots inventory 60 public active (36 commercial + 24 outdoor batch1); Scene chips untouched; do not ping Al |
