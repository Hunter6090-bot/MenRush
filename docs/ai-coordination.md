...
| P0 Video rooms enter with profile identity (no temp pic gate) | merged `#199` on main (`7a16e8b`) | — | Cursor — Zoul 4 Sep 2026 lock; softens #183 gate; join uses profile name/photo; optional temp disguise; leave-no-trace occupancy kept |
...
| Official room temp-identity privacy + leave-no-trace (supersedes #150) | PR `#183` `cursor/room-temp-identity-leave-no-trace-139c` | — | Superseded for join gate by P0 profile-identity (Zoul 4 Sep 2026) — temp remains optional disguise; leave-no-trace occupancy kept |
