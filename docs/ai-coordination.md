...
| --- | --- | --- | --- |
| Merge `origin/main` into five-features PR `#135` | this branch `cursor/five-features-community-discreet-1e25` | — | Cursor cloud — simple overlaps took shipped main (#134–#139 + #165). Drop HEAD combined 039, DiscreetMedia, always-on blur, `/users/sentinel`. **Do not restore MAP\|COMMUNITY** (conflicts with #165). |
