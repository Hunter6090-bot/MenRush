...
| --- | --- | --- | --- |
| Discover floating map chat dock (port of #96) | this branch `cursor/map-chat-dock-ac6d` PR `#240` | — | Cursor cloud — fresh port onto main+#237; mig **056** map_feed only (not 031); `io.to(user:)` fan-out; Discover-only dock; no MessagingHub rooms re-nest; no premium/avatar drive-bys; comment on #96 → close in favor; do not ping Al |
