...
| --- | --- | --- | --- |
| Match profile actions: Pass \| Open chat \| Unmatch | PR `cursor/profile-actions-unmatch-7714` | — | Cursor cloud — Message→Unmatch+confirm; DELETE /users/like/:id; do not touch rooms/#150 or #97–#99 |
