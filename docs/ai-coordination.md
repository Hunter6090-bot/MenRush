...
| --- | --- | --- | --- |
| P0 promo BSF26 — 3mo Premium (fest contact) | this branch `cursor/promo-bsf26-3mo-eafe` | — | Cursor cloud — Al P0: code BSF26 exact; 3mo Pride clock reuse; enter through end 5 Oct 2026 UK (BST→UTC); no Pride stack; replaces 30d gift; Terms 7.8; quiet face; draft; do not merge |
