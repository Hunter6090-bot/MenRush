...
| --- | --- | --- | --- |
| Official video rooms P0: temp-identity leak + small group 3–5 + mesh recovery | PR `cursor/rooms-temp-identity-privacy-e987` | — | Cursor cloud — never COALESCE temp photo to account; join after gate; restore create-small-group; ICE restart; do not touch #97–#99 |
