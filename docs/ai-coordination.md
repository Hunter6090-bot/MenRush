...
| --- | --- | --- | --- |
| Hot Spots GREEN expand (25 + 4 Legal follow-on, Zoul merge-green) | this branch `cursor/hotspots-green-expand-d4a3` PR `#237` | — | Cursor cloud — Legal GREEN only; mig 053+054 + `commercial-venues.green-expand-2026-09.json`; 29 seeded / 0 deferred; soft-four AMBER held (Centre Stage, Eden, Equator, Blayds); keep-list intact; hand-verified lat/lng; copy name+type+area only; Brand Cruise density claims held; BOA90 soft-refresh via seed script; do not ping Al |
