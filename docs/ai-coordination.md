...
| --- | --- | --- | --- |
| P0/P1 chat photo viewer Back/Close + standard open frame | this branch `cursor/chat-photo-viewer-back-45cc` | — | Cursor cloud — beta UX: Back/Close (+ Android Back) return to same 1:1 thread; scroll restore; safe-area chrome; opened images fit fixed ~90vw×75vh contain frame (not native res); view-once + media lock unchanged; #97–#99 parked; do not ping Al; Product squash-merge |
