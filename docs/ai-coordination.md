...
| --- | --- | --- | --- |
| Map Legal disclaimer dismiss X (post-#259/#260) | this branch `cursor/map-disclaimer-dismiss-x-246c` PR `#261` | — | Cursor cloud — Al ORDER: dismiss X once read; persist localStorage (`menrush_hotspots_map_banner_dismissed`); Legal quiet face exact unchanged after #259; no commercial-only / Meet in public / outdoor soft-sell; two-men mark untouched; tech only no Studio; draft PR; do not merge; do not ping Al |
