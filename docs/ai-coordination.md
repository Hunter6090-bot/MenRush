...
| --- | --- | --- | --- |
| P0 Nearby Live honesty + map gestures + Pulse clear + speed | this branch `cursor/nearby-live-map-pulse-p0-6efa` | — | Cursor cloud — Live = online presence not radius All; Pulse FAB hidden on expanded map; memo/filter/gesture thrash cut; #213 email-confirm / #97–#99 / Cruise sales / media lock parked; BOA90 QA; do not ping Al |
