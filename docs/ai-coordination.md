...
| --- | --- | --- | --- |
| Community post comments (text replies on `/stream`) | this branch `cursor/five-features-community-discreet-1e25` PR `#186` | — | Cursor cloud — `community_post_comments` **044** (043 taken by Veriff #178); GET/POST `/api/community/posts/:id/comments`; ≤280; free; blocks respected; no media. Do not restore MAP\|COMMUNITY (#165). |
