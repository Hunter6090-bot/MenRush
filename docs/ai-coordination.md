...
| --- | --- | --- | --- |
| P0 discover map chrome declutter (Al ops busy/clumsy) | this branch `cursor/discover-map-chrome-declutter-2943` | — | Cursor cloud — Al P0: one corner cluster (BR locate+zoom, BL Chat); kill map status pill duplicate; short outdoor-live disclaimer (#258); pin cycle+zoom labels keep true lng/lat (#254); draft PR; do not merge; do not ping Al |
