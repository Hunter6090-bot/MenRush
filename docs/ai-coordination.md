...
| P0 map vertical stack (Cruise/people pins) | merged `#254` on main (`a86da98`) | — | Cursor cloud — Al P0: HotSpotPin root `position:relative` overrode Mapbox absolute → zoomed-out vertical column; remove override + CSS lock + mercator; Hot Spots inventory 60 public active (36 commercial + 24 outdoor batch1); Scene chips untouched; do not ping Al |
