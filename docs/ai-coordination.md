...
| --- | --- | --- | --- |
| P0 promo BSF26 — BearScotsFest 2026 only (3mo Premium) | this branch `cursor/promo-bsf26-3mo-eafe` PR `#265` | — | Cursor cloud — Al CLOCK LOCK baked: before 1 Oct London→start 1 Oct; on 1 Oct→1 Oct; on 2–5 Oct→that London day; fest-only; claim-by end 5 Oct London; no Pride stack; replaces 30d; Product merge-ready (do not self-merge); quiet face; draft |
