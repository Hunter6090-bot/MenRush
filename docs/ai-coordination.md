...
| Discovery filter choices (hookup tags + 60+/custom age) | branch `cursor/discovery-filter-choices-ecd5` | — | Cursor cloud — expand vibe/scene/connection/looking_for/body/tribe + age 60+/custom; no new filter types; no dating-coded tags; do not touch #97–#99 |
