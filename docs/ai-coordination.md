...
| --- | --- | --- | --- |
| UK commercial venue Cruise / Hot Spots seed (Legal GREEN only) | this branch `cursor/commercial-venue-hotspots-seed-4c31` | — | Cursor cloud — migration 048 commercial lock; retire outdoor RED; Brand Hot Spots chip + Cruise pin + helper; ops seed path (no invent coords / no scrape); keep-list 4 prior curated saunas; #213/#97–#99 parked; BOA90; do not ping Al |
