...
| --- | --- | --- | --- |
| Trust Centre squash: one optional Veriff + one badge; drop Authentic person | this branch `cursor/trust-centre-one-veriff-badge-54f6` | — | Cursor cloud — Zoul lock 3 Sep 2026; Adult off Trust Centre; no honor ladder; FEATURES.requireIdVerification false; #97 parked; do not auto-approve; do not ping Al |
