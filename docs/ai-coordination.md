...
| --- | --- | --- | --- |
| Brand Profile extras: Map photo + Hosting options | this branch `cursor/profile-map-photo-hosting-6ab0` | — | Cursor cloud — Brand signed 8 Sep 2026: Map photo plumbing + Nearby discovery face; Hosting Not hosting/Can host/Hosting now; no Health/Scene; #97–#99 parked; do not ping Al |
| Profile essentials: list all missing + highlight on /profile | merged `#206` on main | — | Cursor cloud — Al UX 6 Sep: Settings chips; Profile copper highlight + Needed cue |
