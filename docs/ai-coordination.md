...
| --- | --- | --- | --- |
| Soft Brand: Events drop Meet in public (post-#259) | this branch `cursor/events-drop-meet-in-public-c8ae` | — | Cursor cloud — leftover Events location-gate cue still said Meet in public · Consent first; kill Meet in public for outdoor-live consistency; keep Consent first.; no outdoor marketing swap; two-men mark untouched; draft PR; do not merge; do not ping Al |
