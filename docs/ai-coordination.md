...
| --- | --- | --- | --- |
| P0 Video rooms enter with profile identity (no temp pic gate) | this branch `cursor/rooms-profile-identity-no-temp-gate-6405` | — | Cursor cloud — Zoul 4 Sep 2026 lock; softens #183 gate; join uses profile name/photo; optional temp disguise; leave-no-trace occupancy kept; do not merge; do not ping Al |
