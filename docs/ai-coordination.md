...
| Pride waitlist = MENRUSH invite + 3mo Premium from launch | PR branch `cursor/pride-waitlist-beta-invite-0adc` | — | Cursor cloud — /pride main CTA waitlist; same beta invite; window 21–31 Aug; no second Pride promo family; do not touch #97–#99 |
