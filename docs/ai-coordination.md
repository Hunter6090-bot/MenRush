...
| --- | --- | --- | --- |
| Adult Assurance enforcement (issue #50) | PR branch `cursor/adult-assurance-enforcement-fac3` | — | Cursor cloud — backend gate ON by default, no grandfathering; CI `test:security` |
