...
| --- | --- | --- | --- |
| Nearby Grid-first + three-up phone (Brand lock 31 Aug 2026) | PR `#165` `cursor/grid-three-up-phone-b1fe` | — | Cursor cloud — Grid home start; Map toggle (no MODE); three-up phone; desktop wide grid + right panel; BrandMark only (no MENRUSH type); no fake counts; rebased after #167/#168; do not merge until phone share; do not mix #163/#97–#99 |
