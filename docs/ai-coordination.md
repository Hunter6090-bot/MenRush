...
| --- | --- | --- | --- |
| Hot Spots GREEN expand (25 venues, Zoul merge-green) | this branch `cursor/hotspots-green-expand-d4a3` | — | Cursor cloud — Legal GREEN only; mig 053 + `commercial-venues.green-expand-2026-09.json`; keep-list intact; AMBER/RED untouched; 25 seeded / 0 deferred; hand-verified lat/lng (venue site / Ordnance / OSM named POI); copy name+type+area only; Brand Cruise density claims held; BOA90 soft-refresh via seed script; do not ping Al |
