...
| Discreet Mode media blur (item 2/5; Ghost untouched) | PR `cursor/discreet-mode-media-blur-14aa` | — | Cursor cloud — `media_clear` + CSS blur; `DISCREET_MEDIA_BLUR` opt-in (default off); no public copy |
