...
| --- | --- | --- | --- |
| P0 promo BSF26 — BearScotsFest 2026 only (3mo Premium) | this branch `cursor/promo-bsf26-3mo-eafe` PR `#265` | — | Cursor cloud — Al lock: BSF26 = BearScotsFest 2026 ONLY (not general promo); rugby codes later (Title Case club names) — do not invent here; claim-by end 5 Oct 2026 Europe/London; no Pride stack; replaces 30d; CLOCK OPEN pride_mirror interim; Product HOLD merge; quiet face; draft; do not merge |
