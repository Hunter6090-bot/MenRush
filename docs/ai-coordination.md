...
| --- | --- | --- | --- |
| Login 500 on men-rush Vercel unique URL | this branch `cursor/fix-login-cors-vercel-alias` | — | Cursor — CORS allowed `menrush-*` only; MenRuch project hosts are `men-rush-*`. Sign In from unique prod URL returned Internal server error. menrush.com already worked. Do not mix #97–#99 |
