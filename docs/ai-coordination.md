...
| --- | --- | --- | --- |
| Verified profiles landing copy (replace Verified bodies) | PR `cursor/verified-profiles-landing-51f5` | — | Cursor cloud — ComingSoon hero + design-lock e2e + marketing rule; no Pride / #118 / Railway |
