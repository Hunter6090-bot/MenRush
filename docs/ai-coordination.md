...
| --- | --- | --- | --- |
| Nearby empty face: transparent cutout + face zoom (`FadedBrandFace`) | this branch `cursor/faded-brand-face-cutout-zoom-12c5` | — | Cursor cloud — Al owner lock: use `medallion-transparent.png` (no black disc); CSS object-cover + ~220–240% zoom on two faces; keep fade opacity + placeholder helper; BrandMark unchanged; BOA90 glance after Vercel; do not ping Al |
