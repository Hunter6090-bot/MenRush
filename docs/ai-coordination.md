...
| --- | --- | --- | --- |
| Adult-assurance status-poll 429 (dedicated limiter) | this branch `cursor/adult-assurance-status-poll-limiter-0cd4` → PR into `#97` branch | — | Cursor cloud — Zoul Friday Brief: status GET shared mutation limiter 12/15m; ~60 polls/signup → 429. Dedicated poll limiter 120/15m; auth/mutation ceilings unchanged; HOLD #97 merge until Al BOA90; do not ping Al |
