...
| --- | --- | --- | --- |
| P0 promo BSF26 — 3mo Premium (fest contact) | this branch `cursor/promo-bsf26-3mo-eafe` PR `#265` | — | Cursor cloud — Legal soft glance LOCK: BSF26 exact; claim-by end 5 Oct 2026 Europe/London; no Pride stack; replaces 30d gift; reject double-claim; 18+ #97; CLOCK OPEN pending Al — interim default pride_mirror flipable A/B; Product HOLD merge; quiet face; draft; do not merge |
