...
| --- | --- | --- | --- |
| Chat open: no empty/new-thread flash on existing 1:1 | PR `cursor/chat-no-empty-flash-916f` | — | Cursor cloud — historyReady gate + inbox preview/session cache; hold merge; do not ping Al; #97–#99 / pride / Social Studio / Railway host untouched |
