...
| --- | --- | --- | --- |
| Referral system (codes + verified unlock + pending payout) | this branch `cursor/referral-system-199f` | — | Cursor cloud — Zoul order; optional register field; count after is_verified; 3→1mo Premium; 20% pending on paid upgrade; no CCBill/Veriff/#97–#99; always-Premium BOA90/Bigbear25/HantsBear preserved |
