...
| --- | --- | --- | --- |
| Pride sole public offer (`/pride`; closed `/brightonpride` → redirect) | draft PR `#118` `cursor/pride-landing-promo-9233` (folds #119) | — | Cursor cloud — public + personal Pride redeem at register (editable promo); grandfather truthful; 035 no-op + 037; launch-slip grant; brand-only /pride; do not merge until Legal re-read |
