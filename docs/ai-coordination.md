...
| --- | --- | --- | --- |
| Community Space (replace Live Profile List) | PR `cursor/community-space-2c5d` | — | Cursor cloud — item 1/5; text posts ≤280; MAP\|COMMUNITY toggle; desktop list = feed; no media blur / panic / More filters / venue check-in |
