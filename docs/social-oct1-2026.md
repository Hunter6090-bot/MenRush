...
## Six-week run-up (from week of 18 Aug 2026 → 1 Oct)

| Week | Dates (UK) | Theme | Content focus |
|---|---|---|---|
| 1 | 18–24 Aug | Launch signal | Positioning, anti-noise, “built for men who know what they want.” |
| 2 | 25–31 Aug | Nearby / rooms energy | Proximity truth, “who’s near you right now,” rooms as *coming* atmosphere — not a live catalog claim. |
| 3 | 1–7 Sep | Early Premium | Waitlist → 30 days Premium at launch. Clean thank-you, no fake scarcity. |
| 4 | 8–14 Sep | Founder / build | Build-in-public, launch clock, product questions. |
| 5 | 15–21 Sep | Trust / discretion | Privacy, verification as free trust layer, adult & discreet. |
| 6 | 22–28 Sep | Countdown pressure | Closing the gap to 1 Oct. Momentum without spam. |
| Launch | 29 Sep–1 Oct | Opening day | UK-first open. Waitlist → live. Premium early reward still honoured. |

Seed status in DB:

- **Weeks 1–2 (18–31 Aug):** full draft posts (X AM/PM, IG, Bluesky, TikTok hooks; Reddit every 2–3 days).
...
## Week 1 — Launch signal (18–24 Aug 2026)

### Tue 18 Aug — Opening signal
...
## Week 2 — Nearby / rooms energy (25–31 Aug 2026)
...
| Day | Angle |
|---|---|
| Tue 25 | Map-first: see who’s near you right now |
| Wed 26 | Less chat-for-weeks, more local signal |
| Thu 27 | Rooms as intentional spaces (coming at launch — no fake inventory) |
| Fri 28 | Night energy / weekend proximity |
| Sat 29 | Discretion + presence (who’s actually around) |
| Sun 30 | Soft ask: what nearby feature would you use first? |
| Mon 31 | Bridge to early Premium week |
...
### Week 5 (15–21 Sep) — Trust / discretion
...
Join the waitlist at menrush.com",2026-08-18,19:30:00,TRUE,FALSE,FALSE,FALSE,FALSE,TRUE,FALSE,FALSE,FALSE,FALSE,FALSE,https://menrush.com/menrush-logo.png,MenRush official logo,POST,FALSE,
```
