 ...
 * Creates a Veriff ID + selfie session and returns sessionUrl for the client SDK.
 */
router.post(
  '/session',
  authMiddleware,
 ...
 * Must receive the raw body for HMAC (mounted with express.raw in server.ts).
 */
router.post(
  '/webhook',
