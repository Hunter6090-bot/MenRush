...
/**
 * MenRush — Discover icon
 * Two profile silhouettes facing each other, echoing the medallion.
 * The DNA of the brand: men finding men.
 */
export function IconDiscover({ size = 24, ...props }: SVGProps<SVGSVGElement> & { size?: number }) {
  return (
    ...
    >
      ...
      {/* Connecting glance — a subtle line between the two */}
