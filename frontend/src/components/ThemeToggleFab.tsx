...
/**
 * Global light / dark / system control — visible on every screen.
 * Tap cycles: Light → Dark → System.
 * Bottom-left so it clears the mobile header actions and Pulse FAB (right).
 */
