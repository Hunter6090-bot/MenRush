 ...
 *
 * - Phone (&lt;768px): 2 columns — roomy enough to tap, not sparse.
...
export const PROFILE_TILE_GRID_CLASS =
  'grid grid-cols-2 gap-2.5 md:grid-cols-[repeat(auto-fill,minmax(140px,1fr))] md:gap-3 lg:grid-cols-[repeat(auto-fill,minmax(150px,1fr))] lg:gap-3.5';
